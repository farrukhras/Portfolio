...
export const projectsData = [
    {
        ...
        projectShortDesc: 'Built an e-commerce store with cart and payment functionalities. Integrated the Stripe API into this application to accept payments from users for the products added to their cart.',
    ...
    },
    {
        ...
        projectShortDesc: 'Using the react-beautiful-dnd library, built a Trello Clone with drag-and-drop functionality for tasks and columns. Integrate Firebase into the application to perform CRUD operations on tasks.',
    ...
    },
    {
        ...
        projectShortDesc: 'The project is an image-sharing application with login and registers functionalities. It allows users to upload and share image posts from their accounts, follow and unfollow other users, and engage in real-time chat with different users.',
    ...
    },
    {
        ...
        projectShortDesc: 'Used Three.js and React Three Fiber to build a 3D Tic Tac Toe game using pre-build components to render 3D shapes. Created a simple scene by setting up the camera, lights, and environment, created a 3D 3x3 grid, along with sphere and cube shapes to display on the scene.',
    ...
    },
    {
        ...
        projectShortDesc: 'Use AR to project your favorite digitally-recorded piano video song from YouTube over your piano to learn by following along.',
        tags: ['Unity', 'EasyAR'],
    ...
    },
    {
        ...
        projectShortDesc: 'Created an educational Augmented Reality based virtual touring application to showcase the heritage and culture of Pakistan, using 3D exhibits, gamification, and periodic quizzes to improve spatial, visual, and story-based learning in children.',
        tags: ['Unity'],
    ...
    },
    {
        ...
        projectShortDesc: 'Engineered a web management solution, incorporating a completely customizable Task Manager, a Form Maker, advanced Admin settings, a Request Panel, a Form Viewer, and a Society dashboard for submitting forms.',
        tags: ['MongoDB, Express, React, Node.js'],
    ...
    },
    {
        ...
        projectShortDesc: 'Built a programmer skill querying application using MongoDB, Golang, and React. The application allows users to add a new programmer, delete a programmer, and search for programmers based on a certain skill.',
        tags: ['MongoDB, Golang, React', 'Gin'],
